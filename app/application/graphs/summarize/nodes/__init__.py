"""Summarize-graph nodes (ADR-0015).
...
and depend only on application ports in ``SummarizeDeps``.
"""
...
from app.application.graphs.summarize.nodes.ingest import ingest, prepare_ingest_update
