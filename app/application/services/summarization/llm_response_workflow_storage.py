...
class LLMWorkflowStorageMixin:
    ...
    def _build_llm_call_payload(
        ...
        payload: dict[str, Any] = {
            ...
            "fallback_model_used": getattr(llm, "fallback_model_used", None),
            "retry_exhausted": bool(getattr(llm, "retry_exhausted", False)),
            "total_latency_ms": getattr(llm, "total_latency_ms", None),
