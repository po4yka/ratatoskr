...
class DeploymentConfig(BaseModel):
    ...
    status_ai_signal_max_age_seconds: int = Field(
        default=86400,
        validation_alias="STATUS_AI_SIGNAL_MAX_AGE_SECONDS",
        ge=300,
        le=604800,
        description="Maximum age of AI circuit-breaker telemetry accepted as current.",
    )
