...
| [0004](0004-langgraph-checkpoint-persistence.md) | LangGraph checkpoint persistence (psycopg3 ↔ asyncpg) | Implemented |
| [0005](0005-rag-grounding-policy.md) | RAG grounding policy for summarization | Implemented |
...
| [0010](0010-graph-orchestration-layering.md) | Graph orchestration — layering & node→port boundary | Implemented |
| [0011](0011-graph-runtime-contract.md) | Graph runtime contract — state, failure, observability | Implemented |
| [0012](0012-vector-write-boundary-rag-freshness.md) | Vector-write boundary & RAG freshness | Implemented |
| [0013](0013-graph-rollout-legacy-migration.md) | Graph cutover & legacy summarize-path removal | Implemented |
| [0014](0014-ports-and-adapters-standard.md) | Ports-and-adapters as the enforced project standard | Implemented for summary graph |
| [0015](0015-summarization-pipeline-target-architecture.md) | Summarization pipeline target architecture | Implemented |
| [0016](0016-unified-retrieval-subsystem.md) | Unified retrieval subsystem | Implemented |
| [0017](0017-streaming-under-the-graph.md) | Streaming under the graph | Implemented |
| [0018](0018-refactor-strategy-and-invariants.md) | Refactor strategy & invariants | Implemented |
| [0019](0019-health-endpoint-envelope-carveout.md) | Health endpoint envelope carve-out | Accepted |
| [0020](0020-related-reads-http-surface.md) | Related reads HTTP surface | Accepted |
