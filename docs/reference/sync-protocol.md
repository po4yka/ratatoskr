...
| Request processing stuck after submit | `app/adapters/content/url_processor.py`, `app/db/models/core.py::RequestProcessingJob`, `app/adapters/content/streaming/` | `docs/reference/troubleshooting.md#request-stuck-in-processing` |
