...
| HTTP 429 / rate-limit errors during a run | Request cadence too aggressive | Increase `AI_BACKUP_REQUEST_DELAY_MS` (default 1500 ms) and optionally lower `AI_BACKUP_MAX_REQUESTS_PER_RUN` |
