...
| Reader source recovery | `ratatoskr_source_content_*` plus `ratatoskr_taskiq_*{task="ratatoskr.source_content.reconcile"}` | Exact missing count, oldest-row age, repair outcomes, and stopped-reconciler alert |
